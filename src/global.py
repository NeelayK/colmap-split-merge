# ----------------------------------------------------------------------------------------------------------------
# Does global reconstruction on the entire dataset using COLMAP's  ALIKED features and LightGlue matching.
# Neccesity if you want to run the density analysis script to get 3D point counts per image for the probabilistic splitter.
# ----------------------------------------------------------------------------------------------------------------
